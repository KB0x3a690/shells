    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <span class="fw-medium overflow-auto">Disabled Functions: <?= $showdisbfuncs; ?></span>
        </div>
      </div>
    </div>
  </div>
                ...
                ?>
                  <tr>
                    ...
                    <td width="90">
                      ...
                      <a href='?path=<?= $path . $separator . $items; ?>&a=chmod' class="btn btn-info btn-sm">
                  ...
                  ?>
                    <tr>
                      ...
                      <td width="90">
                        ...
                        <a href='?file=<?= "$path$separator$items"; ?>&a=chmod' class="btn btn-info btn-sm">
                          <i class="bi bi-gear-fill"></i>
                        </a>
